...
The word tooltip and sentence explosion merge language, gloss, tags, and sentence translation into one structured request. Each field prompt is extra instruction only. Sentence analysis (the Analyze button) remains a separate streaming request.
